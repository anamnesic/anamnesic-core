...
export type BduiPage = SchemaType<"BduiPage">;
export type BduiLayout = SchemaType<"BduiLayout">;
export type BduiComponent = SchemaType<"BduiComponent">;
export type BduiComponentRegistration = SchemaType<"BduiComponentRegistration">;
export type BduiRegistry = SchemaType<"BduiRegistry">;
export type BduiGetPageParams = SchemaType<"BduiGetPageParams">;
export type BduiGetPageResult = SchemaType<"BduiGetPageResult">;
export type BduiActionResponse = SchemaType<"BduiActionResponse">;
export type BduiActionParams = SchemaType<"BduiActionParams">;
export type BduiRegistryParams = SchemaType<"BduiRegistryParams">;
